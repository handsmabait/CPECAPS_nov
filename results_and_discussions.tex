...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{frame_000223.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{frame_000225.jpg}
    \caption{Training data sample demonstrating }
    \label{fig:train_sample_2}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{frame_000226.jpg}
